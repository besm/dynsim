...
/**
 * A Catmull-Rom spline object. Use the SplineFactory class to create splines of
 * this type.
 * 
...
class CatmullRomSpline extends CubicSpline {
	/**
	 * Construct a Catmull-Rom spline. Package local; Use the SplineFactory to
	 * create splines of this type. The control points are used according to the
	 * definition of Catmull-Rom splines.
	 * 
	 * @param controlPoints
