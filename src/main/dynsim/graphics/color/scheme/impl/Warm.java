...
public class Warm extends AbstractColorScheme {
	 ...
	 * @param fader
	 */
	public Warm(final ColorRamp fader) {
		super(fader);
	}
	...
	public int[][] loadPals() {
		...
		final int[] tmp = fader.getColors(50, new Color(164, 134, 0), new Color(210, 200, 0));
		final int[] tmp2 = fader.getColors(50, new Color(155, 50, 0), new Color(164, 134, 0));
		final int[] tmp3 = fader.getColors(50, new Color(100, 150, 0), new Color(155, 50, 0));
		final int[] tmp4 = fader.getColors(50, new Color(50, 50, 200), new Color(100, 150, 0));
